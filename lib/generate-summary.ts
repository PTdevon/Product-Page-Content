...
Begin with the product type and primary keyword, making it immediately clear what the product is. Within the first few words, establish the distinctive aesthetic, material, design, or visual character that makes it stand out. The reader should know both what the product is and why it is appealing almost immediately.
...
10. The product type must appear within the first four words of the summary — this is non-negotiable. For a necklace, the word "necklace" must be in the opening phrase. A summary that opens "A flower charm engraved with…" is wrong — it must open "A flower charm necklace…" or "A sterling silver necklace with a flower charm…". The same applies to all product types: ring, bracelet, earrings, purse, bag, mug, candle, and so on. The reader must know immediately what the product is. Do not state where jewellery is worn if obvious from the product type — a ring is on the finger, a necklace is at the neck. Do not reference obvious storage or context ("from a jewellery box"). For necklaces: do not mention the chain. Never mention layering unless the product description explicitly states it. Do not describe where a necklace sits on the body or how it is worn ("worn close", "sits against the skin") unless the description specifies an unusual length. Always call an engraved personalisation element a charm, never a disc — this applies to all product types, not just necklaces. Exception: for cufflinks, never use the word "charm" — refer simply to "engraved cufflinks" or "personalised cufflinks". Never mention colour options, shade variations, or available colours — these are product variants, not copy.
